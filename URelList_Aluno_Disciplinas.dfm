object FrList_Aluno_Disciplinas: TFrList_Aluno_Disciplinas
  Left = 0
  Top = 0
  Caption = 'FrList_Aluno_Disciplinas'
  ClientHeight = 381
  ClientWidth = 854
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object RelList_Aluno_Disciplinas: TQuickRep
    Left = 8
    Top = 8
    Width = 794
    Height = 1123
    ...
    object TitleBand1: TQRBand
      ...
      object QRLabel1: TQRLabel
        ...
        AlignToBand = False
        Caption = 'Listagem de Disciplinas do Aluno'
        Color = clWhite
        Transparent = False
        ExportAs = exptText
    ...
    object QRGroup1: TQRGroup
      ...
      Master = RelList_Aluno_Disciplinas
  ...
  object FDQry_Consulta: TFDQuery
    ...
    SQL.Strings = (
      ...
      '/*QI*/'
      ''
      ' order by alunos.nome, Dalunos.cod_disciplina')
    Left = 544
    Top = 16
