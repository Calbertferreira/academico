unit URelList_Disciplinas_Alunos;
...
type
  TFrList_Disciplinas_Alunos = class(TForm)
    RelList_Disciplinas_Alunos: TQuickRep;
...
var
  FrList_Disciplinas_Alunos: TFrList_Disciplinas_Alunos;
